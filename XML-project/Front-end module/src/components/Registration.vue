    ...
    <form class="form-horizontal" role="form" method="POST" action="/register">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="email" class="form-control" id="email"
                               placeholder="johndoe@example.com" required autofocus v-model="user.email">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="username" class="form-control" id="username"
                               placeholder="john.doe" required autofocus v-model="user.username">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                @click="submitRegistration()"><i class="fa fa-user-plus"></i> Register</button>
            </div>
        </div>
    </form>
</div>
